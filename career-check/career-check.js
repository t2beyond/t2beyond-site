...
const state = { context:{}, answers:{}, contextIndex:0, questionIndex:0, lead:{}, submissionId:null };
...
function renderReport(){
  ...
  document.getElementById('autoReport').innerHTML=`
    ...
    <section class="report-section report-final">
      ...
      <div class="report-review"><span>T2BEYOND CAREER REVIEW</span><h3>Transformer le diagnostic en plan de progression personnalisé.</h3><p>Une Career Review pourra partir de ton Career Check pour clarifier où tu en es, où tu veux aller, ce qui te sépare réellement de cet objectif et les actions les plus pertinentes.</p></div>
...
document.getElementById('restartBtn').addEventListener('click',()=>{state.context={};state.answers={};state.contextIndex=0;state.questionIndex=0;state.lead={};state.submissionId=null;delete state.result;document.getElementById('leadForm').reset();document.getElementById('leadStatus').textContent='';showScreen('introScreen');});
